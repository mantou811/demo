...
{
    //        把traderListDataSource里面的所有内容按照首字母进行分组，完成后存在filterDictionary数组里
...
//    把键取出来（即字母）从小到大进行排序，最后存在groupTitleArray数组，并且绑定到字母跳转的方法
...
//    把”常用“插入到groupTitleArray最前面
    [self.groupTitleArray insertObject:@"常用" atIndex:0];
//    绑定"常用"的数组内容到filterDictionary
